...
# --- API Keys ---
# For better security, use environment variables or a secure secrets management solution.
OPENROUTER_API_KEY = os.getenv("OPENROUTER_API_KEY", "YOUR_OPENROUTER_DEEPSEEK_API_KEY")
OPENROUTER_MODEL = "deepseek/deepseek-chat-v3-0324:free"
OPENROUTER_SITE_URL = "https://example.com"
OPENROUTER_SITE_NAME = "Insight Pulse"

OPENROUTER_MISTRAL_API_KEY = os.getenv("OPENROUTER_MISTRAL_API_KEY", "YOUR_OPENROUTER_MISTRAL_API_KEY")
...
IMAGE_DISPLAY_WIDTH = CANVAS_WIDTH - (LEFT_PADDING * 2)
